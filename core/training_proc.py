...
items_to_descriptions = {
    'image': 'A 3-channel RGB coloured places images.',
    'label': 'A label that is as such -- 0:conveyor, 1:indoor, 2:outdoor'
}


#============== DATASET LOADING ======================
#We now create a function that creates a Dataset class which will give us many TFRecord files to feed in the examples into a queue in parallel.
def get_split(split_name, dataset_dir, file_pattern, tfrecord_filename):
    '''
    ...
    num_samples = 0
    file_pattern_for_counting = tfrecord_filename +'_' + split_name
...
if __name__ == '__main__':
    main(dataset_dir, log_dir, tfrecord_filename)